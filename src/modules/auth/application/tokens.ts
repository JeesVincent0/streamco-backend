...
export const REFRESH_TOKEN_USE_CASE_TOKEN = Symbol('IRefreshTokenUseCase');
export const GENERATE_TOKEN_USE_CASE_TOKEN = Symbol('IGenerateTokenUseCase');
...
export const REFRESH_ACCESS_TOKEN_USE_CASE_TOKEN = Symbol(
